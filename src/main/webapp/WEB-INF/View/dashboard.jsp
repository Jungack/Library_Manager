      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><% out.println(request.getAttribute("membreCount")); %></h3>
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3><% out.println(request.getAttribute("livreCount")); %></h3>
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><% out.println(request.getAttribute("empruntCount")); %></h3>
              <p>Emprunts</p>
            </div>
            <div class="icon">
