	        ...
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <select name="abonnement" class="browser-default">
	              <option value="BASIC" ${(membre.abonnement == null || membre.abonnement == "BASIC") ? " selected" : ""}>Abonnement BASIC</option>
	              <option value="PREMIUM" ${(membre.abonnement != null && membre.abonnement == "PREMIUM") ? " selected" : ""}>Abonnement PREMIUM</option>
	              <option value="VIP" ${(membre.abonnement != null && membre.abonnement == "VIP") ? " selected" : ""}>Abonnement VIP</option>
	            </select>
	          </div>
	        </div>
	        <div class="row">
        ...
        <div class="row">
          <div class="col s12">
	        <table class="striped">
              ...
              <tbody id="results">
				<%@ page import="java.util.List,com.ensta.librarymanager.service.MembreServiceImpl,com.ensta.librarymanager.service.LivreServiceImpl,com.ensta.librarymanager.service.EmpruntServiceImpl,com.ensta.librarymanager.modele.Livre,com.ensta.librarymanager.modele.Emprunt,com.ensta.librarymanager.modele.Membre" %>                	
